...
extension WooShippingConfigMapper {
    ...
    ///
    static let fieldsToLoad = "config.shipments, config.shippingLabelData.currentOrderLabels, config.shippingLabelData.storedData.selected_destination, config.shippingLabelData.storedData.selected_origin"
}
