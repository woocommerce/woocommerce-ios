...
public struct Note: GeneratedFakeable, GeneratedCopiable {
    ...
    public init(
        ...
        self.timestampAsDate = timestampAsDate
        self.kind = kind
        ...
        self.url = url
        self.title = title
        self.subjectAsData = subjectAsData
        self.subject = subject
        self.headerAsData = headerAsData
        self.header = header
        self.bodyAsData = bodyAsData
        self.body = body
        self.metaAsData = metaAsData
        self.meta = meta
    }
}
