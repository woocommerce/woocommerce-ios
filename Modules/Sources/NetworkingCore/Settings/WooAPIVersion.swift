...
public enum WooAPIVersion: String {
    ...
    /// POS server-side design v1 namespace (the M1 staff endpoint and any future POS REST routes
    /// added under the same proposal). Distinct from the older `wcPosV1 = "wc/pos/v1"` namespace
    /// used by catalog sync.
