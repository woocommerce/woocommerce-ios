...
struct POSRefundModalContentView: View {
    ...
    private var content: some View {
        ...
        case .processing(let reviewData):
            POSRefundConfirmationView(
                ...
                shouldUseCardPresentCompletionStyle: orderListModel.refundController.requiresCardPresentRefund,
    ...
    private var isCardPresentRefundError: Bool {
        orderListModel.refundController.requiresCardPresentRefund
    }
    ...
    private func shouldRequireReaderConnection() -> Bool {
        guard orderListModel.refundController.requiresCardPresentRefund else {
            return false
        }
