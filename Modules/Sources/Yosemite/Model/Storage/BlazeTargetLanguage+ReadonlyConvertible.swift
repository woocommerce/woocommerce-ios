...
// MARK: - Storage.BlazeTargetLanguage: ListItemConvertible
//
extension Storage.BlazeTargetLanguage: ListItemConvertible {
    public func toListItem() -> BlazeTargetLanguage {
        return toReadOnly()
    }
}
