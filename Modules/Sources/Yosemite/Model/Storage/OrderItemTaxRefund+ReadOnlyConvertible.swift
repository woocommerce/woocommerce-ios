...
// MARK: - Storage.OrderItemTaxRefund: ListItemConvertible
//
extension Storage.OrderItemTaxRefund: ListItemConvertible {
    public func toListItem() -> Yosemite.OrderItemTaxRefund {
        return toReadOnly()
    }
}
