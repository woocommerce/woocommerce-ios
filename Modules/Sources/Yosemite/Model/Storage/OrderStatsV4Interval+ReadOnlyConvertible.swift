...
// MARK: - Storage.OrderStatsV4Interval: ListItemConvertible
//
extension Storage.OrderStatsV4Interval: ListItemConvertible {
    public func toListItem() -> Yosemite.OrderStatsV4Interval {
        return toReadOnly()
    }
}
