...
final class PaymentIntentTests: XCTestCase {
    ...
    func test_intent_maps_id() throws {
        let intent = try XCTUnwrap(PaymentIntent(intent: mockIntent))
    ...
    func test_init_when_stripeId_is_nil_then_returns_nil() {
        // Given
    ...
    func test_init_when_stripeId_is_empty_then_returns_nil() {
        // Given
