...
func assertThat(container: NSPersistentContainer, hasNoEntity entityName: String, file: StaticString = #filePath, line: UInt = #line) {
...
/// given `entityName`.
func assertThat(container: NSPersistentContainer, hasEntity entityName: String, file: StaticString = #filePath, line: UInt = #line) {
    let description = NSEntityDescription.entity(forEntityName: entityName, in: container.viewContext)
