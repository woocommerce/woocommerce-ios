...
//        let assetColor = UIColor(named: murielColor.assetName(), in: .sourceBundle, compatibleWith: nil)
//
...
//            let assetColor = UIColor(named: colorStudio.assetName(), in: .sourceBundle, compatibleWith: nil)
//
//            return color == assetColor
//        }.reduce(true, { $0 && $1 })
//    }
...
//extension Bundle {
//
//    @objc public class var sourceBundle: Bundle {
//        // Workaround for https://forums.swift.org/t/swift-5-3-swiftpm-resources-in-tests-uses-wrong-bundle-path/37051
//        guard let testBundlePath = ProcessInfo.processInfo.environment["XCTestBundlePath"],
//           let bundle = Bundle(path: "\(testBundlePath)/Modules_WooFoundation.bundle") else {
//            fatalError("Loading Bundle with test workaround outside of tests environment.")
//        }
//
//        return bundle
//    }
