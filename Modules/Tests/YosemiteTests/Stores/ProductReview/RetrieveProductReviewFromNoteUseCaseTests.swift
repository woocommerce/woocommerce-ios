...
private extension RetrieveProductReviewFromNoteUseCaseTests {
    enum TestData {
        ...
        static var product: Product { Product.fake().copy(siteID: siteID, productID: 756_611) }
        static var productReview: ProductReview { MockProductReview().make(siteID: siteID, reviewID: 1_981_157, productID: product.productID) }
        static var note: Note { MockNote().make(noteID: 9_981, metaSiteID: siteID, metaReviewID: productReview.reviewID) }
    }
}
