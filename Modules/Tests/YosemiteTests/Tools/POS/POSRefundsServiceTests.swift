...
struct POSRefundsServiceTests {
    ...
    @Test func createRefund_then_calls_calculator_with_correct_parameters() async throws {
        ...
        // When
        try await sut.createRefund(orderID: orderID, items: items, reason: reason, isAutomaticRefund: true, staffUserID: nil)
    ...
    @Test func createRefund_then_passes_fraction_digits_from_currency_settings_to_calculator() async throws {
        ...
        // When
        try await sut.createRefund(orderID: 456, items: [], reason: nil, isAutomaticRefund: true, staffUserID: nil)
    ...
    @Test func createRefund_then_calls_remote_with_correct_site_id_and_order_id() async throws {
        ...
        // When
        try await sut.createRefund(orderID: orderID, items: items, reason: nil, isAutomaticRefund: true, staffUserID: nil)
    ...
    @Test func createRefund_then_builds_refund_with_correct_amount_from_calculator() async throws {
        ...
        // When
        try await sut.createRefund(orderID: 456, items: [], reason: "Test reason", isAutomaticRefund: true, staffUserID: nil)
    ...
    @Test func createRefund_when_automatic_refund_disabled_then_sets_create_automated_to_false() async throws {
        ...
        // When
        try await sut.createRefund(orderID: 456, items: [], reason: nil, isAutomaticRefund: false, staffUserID: nil)
