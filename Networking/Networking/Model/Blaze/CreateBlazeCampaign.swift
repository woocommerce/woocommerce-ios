...
public struct CreateBlazeCampaign: Encodable, GeneratedFakeable, GeneratedCopiable {
    ...
    public init(origin: String,
                ...
                targetUrn: String,
                type: String) {
        let (targetUrl, urlParams) = destinationURL.targetURLAndParams()
...
// MARK: Helper to fetch URL and params
private extension String {
    func targetURLAndParams() -> (targetUrl: String, urlParams: String) {
        ...
        urlParams = urlComponents.query ?? ""

        // Remove query to get URL with params
        urlComponents.query = nil
        targetUrl = urlComponents.url?.absoluteString ?? ""
