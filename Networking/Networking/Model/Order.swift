...
public struct Order: Decodable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        let slug = statusKey.rawValue
        let status = OrderStatus(name: String(), siteID: siteID, slug: slug)
