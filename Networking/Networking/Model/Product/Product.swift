...
extension Product: Equatable {
    /// We implement this because arrays coming from a set might have
    /// different order, thus stating inequality for the same products with
    /// the synthesized automatic conformance to Equatable
    ///
    public static func == (lhs: Product, rhs: Product) -> Bool {
        ...
        lhs.relatedIDs.sorted() == rhs.relatedIDs.sorted() &&
        lhs.upsellIDs.sorted() == rhs.upsellIDs.sorted() &&
        lhs.crossSellIDs.sorted() == rhs.crossSellIDs.sorted() &&
        ...
        lhs.variations.sorted() == rhs.variations.sorted() &&
        lhs.groupedProducts.sorted() == rhs.groupedProducts.sorted() &&
        lhs.menuOrder == rhs.menuOrder &&
        lhs.bundleStockStatus == rhs.bundleStockStatus &&
        lhs.bundleStockQuantity == rhs.bundleStockQuantity
    }
}
