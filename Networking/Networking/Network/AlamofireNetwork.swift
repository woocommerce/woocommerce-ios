...
public class AlamofireNetwork: Network {
    ...
    public required init(credentials: Credentials?) {
        ...
        self.requestAuthenticator = ApplicationPasswordRequestProcessor(requestAuthenticator: DefaultApplicationPasswordRequestAuthenticator(credentials: credentials))
    }
