...
public class OrderStatsRemote: Remote {
    ...
    ///
    public func loadOrderStats(for siteID: Int, unit: OrderStatGranularity, latestDateToInclude: String, quantity: String, completion: @escaping ([OrderStatItem]?, Error?) -> Void) {
