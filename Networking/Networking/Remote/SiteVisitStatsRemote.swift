...
public class SiteVisitStatsRemote: Remote {
    ...
    ///
    public func loadSiteVisitorStats(for siteID: Int, unit: OrderStatGranularity, latestDateToInclude: Date, quantity: Int, completion: @escaping (SiteVisitStats?, Error?) -> Void) {
