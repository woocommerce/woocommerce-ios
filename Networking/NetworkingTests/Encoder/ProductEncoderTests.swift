...
final class ProductEncoderTests: XCTestCase {
    ...
    func test_it_encodes_subscription_into_meta_data_when_type_is_variableSubscription() throws {
        // Given
        let subscription = ProductSubscription(length: "3",
                                               period: .week,
                                               periodInterval: "5",
                                               ...
                                               trialLength: "1",
                                               trialPeriod: .month)
        let product = Product.fake().copy(productTypeKey: "variable-subscription",
                                          subscription: subscription)
