...
class SitePluginsMapperTests: XCTestCase {
    ...
    func test_SitePlugin_fields_are_properly_parsed() {
        ...
        XCTAssertEqual(wooCommerceSubscriptionsPlugin.pluginUri, "https://www.woo.com/products/woocommerce-subscriptions/")
        XCTAssertEqual(wooCommerceSubscriptionsPlugin.authorUri, "https://woo.com/")
