...
final class ProductVariationsRemoteTests: XCTestCase {
    ...
    ///
    func testLoadAllProductVariationsProperlyReturnsParsedData() async throws {
        // Given
        ...
        // When
        let productVariations = try await remote.loadAllProductVariations(for: sampleSiteID,
    ...
    ///
    func testLoadAllProductVariationsProperlyRelaysNetwokingErrors() async {
        // Given
        let remote = ProductVariationsRemote(network: network)

        // When/Then
        do {
            _ = try await remote.loadAllProductVariations(for: sampleSiteID,
                                                         productID: sampleProductID,
                                                         variationIDs: [])
    ...
    func test_loadAllProductVariations_with_non_empty_variationIDs_adds_include_parameter() async throws {
        // Given
        let remote = ProductVariationsRemote(network: network)
        ...
        _ = try await remote.loadAllProductVariations(for: sampleSiteID,
                                                     productID: sampleProductID,
                                                     variationIDs: includedVariationIDs)
    ...
    func test_loadAllProductVariations_with_empty_variationIDs_does_not_add_include_parameter() async throws {
        // Given
        let remote = ProductVariationsRemote(network: network)
