...
private extension ProductsRemoteTests {
    ...
    func sampleTags() -> [Networking.ProductTag] {
        let tag1 = ProductTag(siteID: sampleSiteID, tagID: 37, name: "room", slug: "room", count: 0)
        let tag2 = ProductTag(siteID: sampleSiteID, tagID: 38, name: "party room", slug: "party-room", count: 0)
        let tag3 = ProductTag(siteID: sampleSiteID, tagID: 39, name: "30", slug: "30", count: 0)
        let tag4 = ProductTag(siteID: sampleSiteID, tagID: 40, name: "20+", slug: "20", count: 0)
        let tag5 = ProductTag(siteID: sampleSiteID, tagID: 41, name: "meeting room", slug: "meeting-room", count: 0)
        let tag6 = ProductTag(siteID: sampleSiteID, tagID: 42, name: "meetings", slug: "meetings", count: 0)
        let tag7 = ProductTag(siteID: sampleSiteID, tagID: 43, name: "parties", slug: "parties", count: 0)
        let tag8 = ProductTag(siteID: sampleSiteID, tagID: 44, name: "graduation", slug: "graduation", count: 0)
        let tag9 = ProductTag(siteID: sampleSiteID, tagID: 45, name: "birthday party", slug: "birthday-party", count: 0)
