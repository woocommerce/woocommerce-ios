...
public struct WooPaymentsPayoutsOverview: Codable, GeneratedFakeable, GeneratedCopiable, Equatable {
    public let deposit: WooPaymentsCurrencyPayouts
    public let balance: WooPaymentsCurrencyBalances
    public let account: WooPaymentsAccountPayoutSummary

    public init(deposit: WooPaymentsCurrencyPayouts,
                balance: WooPaymentsCurrencyBalances,
                account: WooPaymentsAccountPayoutSummary) {
...
public struct WooPaymentsCurrencyPayouts: Codable, GeneratedFakeable, GeneratedCopiable, Equatable {
    public let lastPaid: [WooPaymentsPayout]
    public let lastManualPayouts: [WooPaymentsManualPayout]

    public init(lastPaid: [WooPaymentsPayout],
                lastManualPayouts: [WooPaymentsManualPayout]) {
        self.lastPaid = lastPaid
        self.lastManualPayouts = lastManualPayouts
    }

    enum CodingKeys: String, CodingKey {
        case lastPaid = "last_paid"
        case lastManualPayouts = "last_manual_deposits"
    }
}

public struct WooPaymentsPayout: Codable, GeneratedFakeable, GeneratedCopiable, Equatable {
    public let id: String
    public let date: Date
    public let type: WooPaymentsPayoutType
    ...
    public init(id: String,
                date: Date,
                type: WooPaymentsPayoutType,
                amount: Int,
                status: WooPaymentsPayoutStatus,
                bankAccount: String?,
                currency: String,
                automatic: Bool,
                fee: Int,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = try container.decode(WooPaymentsPayoutType.self, forKey: .type)
        self.amount = try container.decode(Int.self, forKey: .amount)
        self.status = container.failsafeDecodeIfPresent(WooPaymentsPayoutStatus.self, forKey: .status) ?? .unknown
...
public struct WooPaymentsManualPayout: Codable, GeneratedFakeable, GeneratedCopiable, Equatable {
    public let currency: String
    public let date: Date
...
public enum WooPaymentsPayoutType: String, Codable, Equatable, GeneratedFakeable, GeneratedCopiable {
    case withdrawal
    case deposit
}
...
public enum WooPaymentsPayoutStatus: String, Codable, Equatable, GeneratedFakeable, GeneratedCopiable {
    case estimated
    case pending
...
public struct WooPaymentsAccountPayoutSummary: Codable, GeneratedFakeable, GeneratedCopiable, Equatable {
    public let payoutsEnabled: Bool
    public let payoutsBlocked: Bool
    public let payoutsSchedule: WooPaymentsPayoutsSchedule
    public let defaultCurrency: String

    public init(payoutsEnabled: Bool,
                payoutsBlocked: Bool,
                payoutsSchedule: WooPaymentsPayoutsSchedule,
                defaultCurrency: String) {
        self.payoutsEnabled = payoutsEnabled
        self.payoutsBlocked = payoutsBlocked
        self.payoutsSchedule = payoutsSchedule
        self.defaultCurrency = defaultCurrency
    }

    public enum CodingKeys: String, CodingKey {
        case payoutsEnabled = "deposits_enabled"
        case payoutsBlocked = "deposits_blocked"
        case payoutsSchedule = "deposits_schedule"
        case defaultCurrency = "default_currency"
    }
}

public struct WooPaymentsPayoutsSchedule: Codable, GeneratedFakeable, GeneratedCopiable, Equatable {
    public let delayDays: Int
    public let interval: WooPaymentsPayoutInterval

    public init(delayDays: Int, interval: WooPaymentsPayoutInterval) {
    ...
    public init(from decoder: Decoder) throws {
        ...
        let weeklyAnchor = try container.decodeIfPresent(WooPaymentsPayoutInterval.Weekday.self, forKey: .weeklyAnchor)
        let monthlyAnchor = try container.decodeIfPresent(Int.self, forKey: .monthlyAnchor)
        let intervalKey = try container.decode(WooPaymentsPayoutInterval.EnumKey.self, forKey: .interval)

        guard let interval = WooPaymentsPayoutInterval(key: intervalKey,
                                                        weeklyAnchor: weeklyAnchor,
                                                        monthlyAnchor: monthlyAnchor) else {
            throw DecodingError.dataCorrupted(.init(codingPath: [CodingKeys.interval],
                                                    debugDescription: "Could not decode payout schedule interval"))
        }
        self.interval = interval
    }
...
public enum WooPaymentsPayoutInterval: Equatable, GeneratedFakeable, GeneratedCopiable {
    case daily
