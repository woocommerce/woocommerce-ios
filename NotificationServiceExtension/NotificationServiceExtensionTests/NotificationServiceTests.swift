@testable import NotificationServiceExtension
import Experiments
import TestKit
import XCTest
...
final class NotificationServiceTests: XCTestCase {
    ...
    override func setUp() {
        ...
        service = NotificationService(featureFlagService: featureFlagService)
    }
    ...
    func test_order_notification_title_body_is_not_modified_when_pushNotificationsForAllStores_is_disabled() throws {
        // Given
        featureFlagService.isPushNotificationsForAllStoresOn = false
    ...
    func test_order_notification_title_body_is_updated_when_pushNotificationsForAllStores_is_enabled() throws {
        // Given
        featureFlagService.isPushNotificationsForAllStoresOn = true
    ...
    func test_order_notification_has_no_threadIdentifier_when_pushNotificationsForAllStores_is_disabled() throws {
        // Given
        featureFlagService.isPushNotificationsForAllStoresOn = false
        ...
        // Then
        XCTAssertEqual(updatedContent.threadIdentifier, "")
    }

    func test_review_notification_has_no_threadIdentifier_when_pushNotificationsForAllStores_is_disabled() throws {
        // Given
        featureFlagService.isPushNotificationsForAllStoresOn = false
        let siteID = Int64(256)
