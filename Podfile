...
target 'WooCommerce' do
  ...
  pod 'WordPressAuthenticator', :git => 'https://github.com/wordpress-mobile/WordPressAuthenticator-iOS.git', :branch => 'update_google_sign-in-v-5', :commit => '5c0aecd804ae8fd42d1bb5c1de3e42da95c3e57b'
