...
extension ProductVariation {
    ...
    @NSManaged public func insertIntoAttributes(_ value: FetchedAttribute, at idx: Int)
    ...
    @NSManaged public func insertIntoAttributes(_ values: [FetchedAttribute], at indexes: NSIndexSet)
    ...
    @NSManaged public func replaceAttributes(at idx: Int, with value: FetchedAttribute)

    @objc(replaceAttributesAtIndexes:withAttributes:)
    @NSManaged public func replaceAttributes(at indexes: NSIndexSet, with values: [FetchedAttribute])

    @objc(addAttributesObject:)
    @NSManaged public func addToAttributes(_ value: FetchedAttribute)

    @objc(removeAttributesObject:)
    @NSManaged public func removeFromAttributes(_ value: FetchedAttribute)
