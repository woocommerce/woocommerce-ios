...
extension StorageType {
    ...
    ///
    public func loadAccountSettings(userId: Int) -> AccountSettings? {
        let predicate = NSPredicate(format: "userID = %ld", userId)
    ...
    ///
    public func loadOrderCount(siteID: Int) -> OrderCount? {
        let predicate = NSPredicate(format: "siteID = %ld", siteID)
    ...
    ///
    public func loadSiteVisitStats(granularity: String, date: String) -> SiteVisitStats? {
    ...
    ///
    public func loadOrderStatsV4(siteID: Int, timeRange: String) -> OrderStatsV4? {
    ...
    ///
    public func loadOrderStatsInterval(interval: String, orderStats: OrderStatsV4) -> OrderStatsV4Interval? {
    ...
    public func loadProductAttribute(siteID: Int, productID: Int, attributeID: Int, name: String) -> ProductAttribute? {
        let predicate = NSPredicate(
            format: "product.siteID = %ld AND product.productID = %ld AND attributeID = %ld AND name ==[c] %@",
    ...
    ///
    public func loadProductSearchResults(keyword: String) -> ProductSearchResults? {
        let predicate = NSPredicate(format: "keyword = %@", keyword)
    ...
    ///
    public func loadProductReviews(siteID: Int) -> [ProductReview]? {
        let predicate = NSPredicate(format: "siteID = %ld", siteID)
    ...
    ///
    public func loadProductReview(siteID: Int, reviewID: Int) -> ProductReview? {
