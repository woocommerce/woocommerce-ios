...
/// Registry of every generated color asset name. Used by the resolution test
/// to assert each token maps to a real asset; keeps the test in sync with codegen.
enum StoreColorPalette {
    static let allAssetNames: [String] = [
        ...
        "storeNeutral",
        "storeOnNeutral",
        "storeNeutralOutlined",
        "storeOnNeutralOutlined",
        "storePrimary",
        "storeOnPrimary",
        "storeSecondary",
        "storeOnSecondary",
        "storeSurface",
        "storeOnSurface",
        "storeOnSurfaceVariant",
        "storeOnSurfaceLowest",
        "storeOnSurfaceHighest",
        "storeInvertedSurface",
        "storeOnInvertedSurface",
        "storeOnInvertedSurfaceVariant",
        "storeTooltip",
        "storeOnTooltip",
        "storeSectionBackground",
        "storeOnSectionBackground",
        "storeSectionBackgroundVariant",
        "storeOnSectionBackgroundVariant",
        "storeOutline",
        "storeOutlineVariant",
        "storeOverlay20",
        "storeOverlay50",
