...
extension WooAnalytics {
    ...
    ///
    public func track(_ stat: WooAnalyticsStat, withProperties properties: [AnyHashable: Any]?) {
        guard userHasOptedIn == true else {
            return
        }
    ...
    ///
    public func track(_ stat: WooAnalyticsStat, withError error: Error) {
        guard userHasOptedIn == true else {
            return
        }
        ...
        let errorDictionary = [
            Constants.errorKeyCode: "\(err.code)",
...
extension WooAnalytics {
    ...
    fileprivate func stopObservingNotifications() {
    ...
    fileprivate func trackApplicationOpened() {
    ...
    fileprivate func trackApplicationClosed() {
        track(.applicationClosed, withProperties: applicationClosedProperties())
        applicationOpenedTime = nil
    }

    fileprivate func applicationClosedProperties() -> [String: Any]? {
    ...
    ///
    fileprivate func updatePropertiesIfNeeded(for stat: WooAnalyticsStat, properties: [AnyHashable: Any]?) -> [AnyHashable: Any]? {
