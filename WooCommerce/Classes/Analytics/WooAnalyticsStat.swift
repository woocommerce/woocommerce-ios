...
public enum WooAnalyticsStat: String {
    ...
    case orderDetailRefundDetailTapped          = "order_detail_view_refund_details_button_tapped"
    case refundedProductsDetailTapped           = "order_detail_view_product_refund_details_button_tapped"
    case refundedProductsPulledToRefresh        = "order_detail_refunded_product_details_pulled_to_refresh"
