...
public enum WooAnalyticsStat: String {
    ...
    case createProductAttribute = "create_product_attribute"
    case createProductAttributeSuccess = "create_product_attribute_success"
    case createProductAttributeFail = "create_product_attribute_fail"
