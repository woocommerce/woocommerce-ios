...
extension ShippingLabelCustomsForm.RestrictionType {
    ...
    private enum Localization {
        static let restrictionTypeNone = NSLocalizedString("None",
                                                           comment: "Restriction type None for contents to be declared in the customs form for Shipping Label flow")
        static let restrictionTypeQuarantine = NSLocalizedString("Quarantine",
                                                                 comment: "Restriction type Quarantine for contents to be declared in the customs form for Shipping Label flow")
        static let restrictionTypeSanitary = NSLocalizedString("Sanitary / Phytosanitary Inspection",
                                                               comment: "Restriction type Sanitary / Phytosanitary Inspection for contents to be declared in the customs form for Shipping Label flow")
        static let restrictionTypeOther = NSLocalizedString("Other",
                                                            comment: "Restriction type Other for contents to be declared in the customs form for Shipping Label flow")
    }
}
