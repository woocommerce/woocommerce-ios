...
struct EnhancedCouponsListView: UIViewControllerRepresentable {
    ...
    typealias UIViewControllerType = EnhancedCouponsListViewController
    ...
    ///
    func makeUIViewController(context: Self.Context) -> EnhancedCouponsListViewController {
        let viewController = EnhancedCouponsListViewController(siteID: siteID)
    ...
    func updateUIViewController(_ uiViewController: EnhancedCouponsListViewController, context: Context) {
        // nothing to do here
    }
