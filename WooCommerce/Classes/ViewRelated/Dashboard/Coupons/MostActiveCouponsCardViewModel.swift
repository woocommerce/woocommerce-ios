...
final class MostActiveCouponsCardViewModel: ObservableObject {
    ...
    func didSelectTimeRange(_ newTimeRange: MostActiveCouponsTimeRange) {
...
private extension MostActiveCouponsCardViewModel {
    @MainActor
    func loadLastTimeRange() async -> MostActiveCouponsTimeRange? {
    ...
    func saveLastTimeRange(_ timeRange: MostActiveCouponsTimeRange) {
