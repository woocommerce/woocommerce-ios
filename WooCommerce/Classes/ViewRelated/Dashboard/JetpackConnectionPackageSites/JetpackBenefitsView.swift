...
struct JetpackBenefitsView: View {
    ...
    private let isJetpackCPSite: Bool
    ...
    var body: some View {
        VStack {
            ...
            VStack(spacing: Layout.spacingBetweenCTAs) {
                ...
                Button(isJetpackCPSite ? Localization.installAction : Localization.loginAction) {
                    if isJetpackCPSite {
                ...
                Button(Localization.notNowAction, action: dismissAction)
...
struct JetpackBenefits_Previews: PreviewProvider {
    static var previews: some View {
        JetpackBenefitsView(isJetpackCPSite: true, onSubmit: {}, onDismiss: {})
            .preferredColorScheme(.light)
            .previewLayout(.fixed(width: 414, height: 780))
        JetpackBenefitsView(isJetpackCPSite: false, onSubmit: {}, onDismiss: {})
            .preferredColorScheme(.light)
