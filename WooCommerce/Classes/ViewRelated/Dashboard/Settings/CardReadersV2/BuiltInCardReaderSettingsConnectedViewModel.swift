...
final class BuiltInCardReaderSettingsConnectedViewModel: CardReaderSettingsPresentedViewModel, ObservableObject {
    ...
    private func reevaluateShouldShow() {
        ...
        } else if connectedReaders.includesBluetoothReader() {
            /// This screen only supports management of BuiltIn readers, and will have started disconnection
...
// MARK: - Localization
//
private extension BuiltInCardReaderSettingsConnectedViewModel {
    enum Localization {
