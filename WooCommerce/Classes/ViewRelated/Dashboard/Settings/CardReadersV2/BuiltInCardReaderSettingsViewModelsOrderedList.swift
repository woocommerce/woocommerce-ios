...
///
final class BuiltInCardReaderSettingsViewModelsOrderedList: CardReaderSettingsPrioritizedViewModelsProvider {
    ...
    init(configuration: CardPresentPaymentsConfiguration) {
        ...
        viewModelsAndViews.append(
            CardReaderSettingsViewModelAndView(
                viewModel: BuiltInCardReaderSettingsSearchingViewModel(
                ...
                viewIdentifier: "BuiltInCardReaderSettingsSearchingViewController"
            )
        )

        viewModelsAndViews.append(
            CardReaderSettingsViewModelAndView(
                viewModel: BuiltInCardReaderSettingsConnectedViewModel(
                    didChangeShouldShow: { [weak self] state in
                        self?.onDidChangeShouldShow(state)
                    },
                    knownReaderProvider: knownReaderProvider,
                ...
                viewIdentifier: "BuiltInCardReaderSettingsConnectedViewController"
            )
        )
