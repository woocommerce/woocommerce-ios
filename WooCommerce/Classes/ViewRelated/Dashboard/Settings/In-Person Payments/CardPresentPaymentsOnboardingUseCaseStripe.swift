...
final class CardPresentPaymentsOnboardingUseCaseStripe: CardPresentPaymentsOnboardingUseCaseProtocol, ObservableObject {
...
// MARK: - Internal state
//
private extension CardPresentPaymentsOnboardingUseCaseStripe {
