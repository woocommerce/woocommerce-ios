...
extension Color {
    static let storeColorCatalog: [StoreColorToken] = [
        ...
        StoreColorToken(name: "storeError", color: .storeError),
        StoreColorToken(name: "storeOnError", color: .storeOnError),
        ...
        StoreColorToken(name: "storeStateLayerOnSurfaceOpacity24", color: .storeStateLayerOnSurfaceOpacity24),
        StoreColorToken(name: "storeTintLayerPrimaryContainerOpacity08", color: .storeTintLayerPrimaryContainerOpacity08),
        StoreColorToken(name: "storeTintLayerPrimaryContainerOpacity10", color: .storeTintLayerPrimaryContainerOpacity10),
        StoreColorToken(name: "storeTintLayerPrimaryContainerOpacity16", color: .storeTintLayerPrimaryContainerOpacity16),
        StoreColorToken(name: "storeTintLayerPrimaryContainerOpacity24", color: .storeTintLayerPrimaryContainerOpacity24),
        StoreColorToken(name: "storePaletteWhite", color: .storePaletteWhite),
        StoreColorToken(name: "storePaletteBlack", color: .storePaletteBlack),
        StoreColorToken(name: "storePaletteBlue20", color: .storePaletteBlue20),
        StoreColorToken(name: "storePaletteBlue40", color: .storePaletteBlue40),
        StoreColorToken(name: "storePaletteBlue60", color: .storePaletteBlue60),
        StoreColorToken(name: "storePaletteGreen20", color: .storePaletteGreen20),
        StoreColorToken(name: "storePaletteGreen40", color: .storePaletteGreen40),
        StoreColorToken(name: "storePaletteGreen60", color: .storePaletteGreen60),
        StoreColorToken(name: "storePaletteOrange20", color: .storePaletteOrange20),
        StoreColorToken(name: "storePaletteOrange40", color: .storePaletteOrange40),
        StoreColorToken(name: "storePaletteOrange60", color: .storePaletteOrange60),
        StoreColorToken(name: "storePalettePink20", color: .storePalettePink20),
        StoreColorToken(name: "storePalettePink40", color: .storePalettePink40),
        StoreColorToken(name: "storePalettePink60", color: .storePalettePink60),
        StoreColorToken(name: "storePalettePurple0", color: .storePalettePurple0),
        StoreColorToken(name: "storePalettePurple5", color: .storePalettePurple5),
        StoreColorToken(name: "storePalettePurple10", color: .storePalettePurple10),
        StoreColorToken(name: "storePalettePurple20", color: .storePalettePurple20),
        StoreColorToken(name: "storePalettePurple30", color: .storePalettePurple30),
        StoreColorToken(name: "storePalettePurple40", color: .storePalettePurple40),
        StoreColorToken(name: "storePalettePurple50", color: .storePalettePurple50),
        StoreColorToken(name: "storePalettePurple60", color: .storePalettePurple60),
        StoreColorToken(name: "storePalettePurple70", color: .storePalettePurple70),
        StoreColorToken(name: "storePalettePurple80", color: .storePalettePurple80),
        StoreColorToken(name: "storePalettePurple90", color: .storePalettePurple90),
        StoreColorToken(name: "storePalettePurple100", color: .storePalettePurple100),
        StoreColorToken(name: "storePaletteSandstone5", color: .storePaletteSandstone5),
        StoreColorToken(name: "storePaletteSandstone10", color: .storePaletteSandstone10),
        StoreColorToken(name: "storePaletteSandstone20", color: .storePaletteSandstone20),
        StoreColorToken(name: "storePaletteSandstone40", color: .storePaletteSandstone40),
        StoreColorToken(name: "storePaletteSandstone60", color: .storePaletteSandstone60),
...
extension StoreIcon {
    static let catalog: [StoreIconToken] = [
        ...
        StoreIconToken(variants: [StoreIcon.Check.solid]),
        ...
        StoreIconToken(variants: [StoreIcon.Minus.solid]),
