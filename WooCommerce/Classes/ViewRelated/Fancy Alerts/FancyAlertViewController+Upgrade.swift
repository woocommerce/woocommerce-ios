...
extension FancyAlertViewController {
    ...
    ///
    public static func makeWooUpgradeAlertController() -> FancyAlertViewController {
    ...
    /// - Returns: FancyAlertViewController of the alert
    ///
    public static func makewWooUpgradeAlertControllerForSitePicker(siteName: String) -> FancyAlertViewController {
...
extension FancyAlertViewController {
    ...
    fileprivate static func makeMoreInfoButtonConfig() -> FancyAlertViewController.Config.ButtonConfig {
