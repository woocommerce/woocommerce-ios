...
extension ShippingLabelPackagesFormViewModel {
    ...
    static func sampleOrder() -> Order {
        return Order(siteID: 1234,
                     ...
                     currency: "USD",
                     customerNote: "",
                     dateCreated: DateFormatter.stringToGMTDateFormatter(with: "2018-04-03T23:05:12"),
                     dateModified: DateFormatter.stringToGMTDateFormatter(with: "2018-04-03T23:05:14"),
                     datePaid: DateFormatter.stringToGMTDateFormatter(with: "2018-04-03T23:05:14"),
                     discountTotal: "30.00",
                     discountTax: "1.20",
                     shippingTotal: "0.00",
                     shippingTax: "0.00",
