...
final class OrdersBadgeController {
    ...
    func updateBadgePosition(_ tab: WooTab, in tabBar: UITabBar) {
        ...
        case .vertical:
            xOffset = showsNinePlusText ? Constants.xOffsetForNinePlus: Constants.xOffsetLandscape
            yOffset = showsNinePlusText ? Constants.yOffsetForNinePlus: Constants.yOffsetLandscape
        }
