...
///
final class ProductCategoryListViewModel: ProductCategoryListViewModelProtocol {
    ...
    func selectOrDeselectCategory(index: Int) {
        ...
        if  !enforceUniqueSelection,
            let indexCategory = selectedCategories.firstIndex(where: { $0.categoryID == categoryViewModel.categoryID}) {
