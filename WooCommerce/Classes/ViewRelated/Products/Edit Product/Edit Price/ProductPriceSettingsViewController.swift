...
private extension ProductPriceSettingsViewController {
    @objc func completeUpdating() {
        ...
        let newTaxClass = taxClass == standardTaxClass ? TaxClass(siteID: standardTaxClass.siteID, name: standardTaxClass.name, slug: "") : taxClass
        onCompletion(regularPrice, newSalePrice, dateOnSaleStart, dateOnSaleEnd, taxStatus, newTaxClass)
    }
}
