...
/// To prevent triggering the handling of repeated barcodes, this class keeps track of a given number of latest values and returns `nil` when a new value has been
/// repeated more than the given frequency threshold.
///
