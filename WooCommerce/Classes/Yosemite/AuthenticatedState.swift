...
class AuthenticatedState: StoresManagerState {
    ...
    init(credentials: Credentials) {
        ...
        services = [
            ...
            AppSettingsStore(dispatcher: dispatcher, storageManager: storageManager, fileStorage: PListFileStorage(), generalAppSettings: ServiceLocator.generalAppSettings),
