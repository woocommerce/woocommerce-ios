...
/// MockStatsVersionStoresManager: allows mocking for stats v4 availability and last shown stats version.
///
class MockStatsVersionStoresManager: DefaultStoresManager {
