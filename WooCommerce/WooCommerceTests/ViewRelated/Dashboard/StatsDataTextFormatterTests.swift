...
final class StatsDataTextFormatterTests: XCTestCase {
    ...
    func test_getChartData_for_totalRevenue_returns_expected_values() {
        ...
        // When
        let totalRevenueData = StatsDataTextFormatter.getChartData(for: .totalRevenue, from: orderStats)
    ...
    func test_getChartData_for_netRevenue_returns_expected_values() {
        ...
        // When
        let netRevenueData = StatsDataTextFormatter.getChartData(for: .netRevenue, from: orderStats)
    ...
    func test_getChartData_for_orderCount_returns_expected_values() {
        ...
        // When
        let orderCountData = StatsDataTextFormatter.getChartData(for: .orderCount, from: orderStats)
    ...
    func test_getChartData_for_averageOrderValue_returns_expected_values() {
        ...
        // When
        let averageOrderValueData = StatsDataTextFormatter.getChartData(for: .averageOrderValue, from: orderStats)
