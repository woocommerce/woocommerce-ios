...
final class AztecUnorderedListFormatBarCommandTests: XCTestCase {
    ...
    func testFormattingIdentifier() {
        let command = AztecUnorderedListFormatBarCommand(optionsTablePresenter: optionsTablePresenter)
        XCTAssertEqual(command.formattingIdentifier, .unorderedlist)
    }
