...
final class OrderTrackingTableViewCellTests: XCTestCase {
    ...
    private struct MockData {
        static let tracking = ShipmentTracking(siteID: 0, orderID: 0, trackingID: "mock-tracking-id", trackingNumber: "XXX_YYY_ZZZ", trackingProvider: "HK POST", trackingURL: "http://automattic.com", dateShipped: nil)
    ...
    func testTopLabelAccessibilityLabelMatchesExpectation() {
        ...
        let expectedLabel = String.localizedStringWithFormat(NSLocalizedString("Shipment Company %@", comment: "Accessibility label for Shipment tracking company in Order details screen. Reads like: Shipment Company USPS"), MockData.tracking.trackingProvider ?? "")
    ...
    func testBottomLabelAccessibilityLabelMatchesExpectation() {
        ...
        let expectedLabel = String.localizedStringWithFormat(NSLocalizedString("Tracking number %@", comment: "Accessibility label for Shipment tracking number in Order details screen. Reads like: Tracking Number 1AZ234567890"), MockData.tracking.trackingNumber)
    ...
    func testButtonAccessibilityhintMatchesExpectation() {
        ...
        let expectedHint = NSLocalizedString("Tracks a shipment.", comment: "Accessibility hint for Track Package button in Order details screen")
