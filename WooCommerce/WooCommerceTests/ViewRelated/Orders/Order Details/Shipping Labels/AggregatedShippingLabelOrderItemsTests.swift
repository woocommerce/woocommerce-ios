...
final class AggregatedShippingLabelOrderItemsTests: XCTestCase {
    ...
    func test_order_items_from_shipping_label_with_matching_Product_have_expected_properties() {
        ...
        let product1 = ProductListItem.fake().copy(productID: 2020, name: "Whoa", price: "25.9", images: [createProductImage(src: imageURL1.absoluteString)])
        let product2 = ProductListItem.fake().copy(productID: 3013, name: "Password", price: "25.9")
