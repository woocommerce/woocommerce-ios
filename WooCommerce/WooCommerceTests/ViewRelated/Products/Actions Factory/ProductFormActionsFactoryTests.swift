...
final class ProductFormActionsFactoryTests: XCTestCase {
    ...
    func test_actions_for_variable_subscription_product_with_variations_price_not_set_contains_noPriceWarning_action_when_editing_subscription_is_enabled() {
        // Given
        let product = Fixtures.variableProductWithVariations.copy(price: "")
        let model = EditableProductModel(product: product)

        // When
        let factory = ProductFormActionsFactory(product: model, formType: .edit, variationsPrice: .notSet, editingSubscriptionEnabled: true)
    ...
    func test_actions_for_variable_subscription_product_with_variations_price_set_does_not_contains_noPriceWarning_action_when_editing_subscription_is_enabled() {
        ...
        // When
        let factory = ProductFormActionsFactory(product: model, formType: .edit, variationsPrice: .set, editingSubscriptionEnabled: true)
    ...
    func test_actions_for_variable_subscription_product_with_no_product_price_set_contains_noPriceWarning_action_when_editing_subscription_is_enabled() {
        // Given
        let product = Fixtures.variableSubscriptionProductWithVariations.copy(price: "")
        let model = EditableProductModel(product: product)

        // When
        let factory = ProductFormActionsFactory(product: model, formType: .edit, variationsPrice: .unknown, editingSubscriptionEnabled: true)
    ...
    func test_actions_for_variable_subscription_product_with_product_price_set_contains_noPriceWarning_action_when_editing_subscription_is_enabled() {
        // Given
        let product = Fixtures.variableSubscriptionProductWithVariations.copy(price: "10.12")
        let model = EditableProductModel(product: product)
    ...
    func test_actions_for_variable_subscription_product_with_attributes_contains_attributes_action_when_editing_subscription_is_enabled() {
        // Given
        let product = Fixtures.variableSubscriptionProductWithVariations.copy(attributes: [
            ProductAttribute.fake().copy(variation: true)
        ])
        let model = EditableProductModel(product: product)
