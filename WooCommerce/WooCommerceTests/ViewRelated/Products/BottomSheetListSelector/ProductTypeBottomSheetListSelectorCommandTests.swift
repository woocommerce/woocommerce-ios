...
final class ProductTypeBottomSheetListSelectorCommandTests: XCTestCase {
    ...
    func test_creation_form_data_contains_grouped_and_variable_types_when_other_requirements_met() {
        // Given
        let subscriptionEligibilityChecker = MockWooSubscriptionProductsEligibilityChecker(isEligible: true)
    ...
    func test_edit_form_data_contains_grouped_and_variable_types_when_other_requirements_met() {
        // Given
        let subscriptionEligibilityChecker = MockWooSubscriptionProductsEligibilityChecker(isEligible: true)
