...
final class TextFieldTextAlignmentTests: XCTestCase {
    ...
    func test_TextFieldText_leading_alignment_maps_to_left_for_LTR() {
        // Arrange
    ...
    func test_TextFieldText_leading_alignment_maps_to_right_for_RTL() {
        // Arrange
        let textAlignment = TextFieldTextAlignment.leading
    ...
    func test_TextFieldText_trailing_alignment_maps_to_right_for_LTR() {
        // Arrange
    ...
    func test_TextFieldText_trailing_alignment_maps_to_left_for_RTL() {
        // Arrange
        let textAlignment = TextFieldTextAlignment.trailing
    ...
    func test_TextFieldText_center_alignment_maps_to_center_for_LTR() {
        // Arrange
    ...
    func test_TextFieldText_center_alignment_maps_to_center_for_RTL() {
        // Arrange
        let textAlignment = TextFieldTextAlignment.center
