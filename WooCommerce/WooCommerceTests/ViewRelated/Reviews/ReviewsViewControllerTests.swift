...
final class ReviewsViewControllerTests: XCTestCase {
    ...
    func test_mark_all_as_ready_bar_button_is_not_present_if_there_are_no_unread_notifications() {
        // When
    ...
    func test_mark_all_as_ready_bar_button_is_visible_if_there_are_unread_notifications_available() throws {
        // When
        ...
        XCTAssertEqual(markAllAsReadyButton.accessibilityIdentifier, "reviews-mark-all-as-read-button")
    }
}
