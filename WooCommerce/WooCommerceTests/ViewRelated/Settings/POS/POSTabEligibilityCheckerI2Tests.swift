...
@MainActor
struct POSTabEligibilityCheckerI2Tests {
    ...
    @Test func checkInitialVisibility_returns_true_when_cached_tab_visibility_is_enabled() async throws {
        // Given
        let checker = POSTabEligibilityCheckerI2(siteID: siteID, eligibilityService: eligibilityService, stores: stores)
...
private extension POSTabEligibilityCheckerI2Tests {
