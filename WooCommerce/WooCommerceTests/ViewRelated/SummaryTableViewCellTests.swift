...
extension SummaryTableViewCellTests {
    fileprivate func sampleOrder() -> Order {
        return Order(
            siteID: 123,
            orderID: 963,
            parentID: 2,
    ...
    fileprivate func sampleAddress() -> Address {
        return Address(
            firstName: "Johnny",
            lastName: "Appleseed",
            company: "",
    ...
    fileprivate func sampleCoupons() -> [OrderCouponLine] {
        let coupon1 = OrderCouponLine(
            couponID: 894,
            code: "30$off",
            discount: "30",
            discountTax: "1.2")
    ...
    fileprivate func sampleCouponsMutated() -> [OrderCouponLine] {
        let coupon1 = OrderCouponLine(
            couponID: 894,
            code: "30$off",
            discount: "20",
            discountTax: "12.2")
        let coupon2 = OrderCouponLine(
            couponID: 12,
            code: "hithere!",
            discount: "50",
            discountTax: "0.66")
    ...
    fileprivate func sampleItems() -> [OrderItem] {
        let item1 = OrderItem(
            itemID: 890,
    ...
    fileprivate func sampleItemsMutated() -> [OrderItem] {
        let item1 = OrderItem(
            itemID: 890,
    ...
    fileprivate func sampleItemsMutated2() -> [OrderItem] {
        let item1 = OrderItem(
            itemID: 890,
            name: "Fruits Basket (Mix & Match Product) 2",
            productID: 52,
    ...
    fileprivate func date(with dateString: String) -> Date {
