...
private extension SummaryTableViewCellTests {
    ...
    func sampleItems() -> [OrderItem] {
        let item1 = OrderItem(itemID: 890,
                              ...
                              productID: 52,
                              variationID: 0,
                              quantity: NSDecimalNumber(integerLiteral: 2),
        ...
        let item2 = OrderItem(itemID: 891,
                              ...
                              productID: 234,
                              variationID: 0,
                              quantity: NSDecimalNumber(floatLiteral: 1.5),
    ...
    func sampleItemsMutated() -> [OrderItem] {
        let item1 = OrderItem(itemID: 890,
                              ...
                              productID: 52,
                              variationID: 0,
                              quantity: NSDecimalNumber(integerLiteral: 10),
                              price: NSDecimalNumber(integerLiteral: 30),
                              sku: "",
                              subtotal: "60.00",
                              subtotalTax: "4.00",
        ...
        let item2 = OrderItem(itemID: 891,
                              ...
                              productID: 234,
                              variationID: 0,
                              quantity: NSDecimalNumber(integerLiteral: 3),
                              price: NSDecimalNumber(integerLiteral: 0),
                              sku: "5555-A",
                              subtotal: "30.00",
                              subtotalTax: "0.40",
        ...
        let item3 = OrderItem(itemID: 23,
                              ...
                              productID: 12,
                              variationID: 0,
                              quantity: NSDecimalNumber(integerLiteral: 1),
