    ...
    static var defaultStrings: WordPressAuthenticatorDisplayStrings {
        return WordPressAuthenticatorDisplayStrings(
            ...
            openMailLoginInstructions: NSLocalizedString("Check your email on this device, and tap the link in the email you receive from WordPress.com.",
                                                         comment: "Instruction text displayed on the magic link login screen after a login link has been sent, guiding users to check their email and tap the verification link from WordPress.com."),
            verifyMailLoginInstructions: NSLocalizedString("A WordPress.com account is connected to your store credentials. To continue, we will send a verification link to the email address above.",
                                                         comment: "This instructional text appears on a WordPress authentication screen during the WooCommerce store login process, explaining to users that their store credentials are linked to a WordPress.com account and that a verification email will be sent for login verification."),
            alternativelyEnterPasswordInstructions: NSLocalizedString("Alternatively, you may enter the password for this account.",
                                                                      comment: "This instructional text appears on a login screen to inform users they can manually enter their password instead of using the magic link email authentication method. It's displayed as guidance text below or near the password input field when users have the option to bypass the email verification flow."),
            ...
            loginTermsOfService: NSLocalizedString("By continuing, you agree to our _Terms of Service_.", comment: "This legal disclaimer text appears on the login screen as part of the authentication flow, informing users that by proceeding with login they agree to the Terms of Service. The underscores around 'Terms of Service' indicate that this text should be displayed as a clickable link or underlined text."),
