...
final class WordPressComOAuthErrorTests: XCTestCase {

    func test_loginErrorMessage_when_account_is_blocked_then_shows_backend_message() {
        ...
        XCTAssertEqual(error.loginErrorMessage, blockedMessage)
    }

    func test_loginErrorMessage_when_wrong_password_then_shows_backend_message() {
        ...
        XCTAssertEqual(error.loginErrorMessage, wrongCredentials)
    }

    func test_loginErrorMessage_when_login_limit_exceeded_then_shows_backend_message() {
        ...
        XCTAssertEqual(error.loginErrorMessage, limitMessage)
    }

    func test_loginErrorMessage_when_no_description_then_falls_back_to_localized_description() {
        ...
        XCTAssertEqual(error.loginErrorMessage, error.localizedDescription)
    }

    func test_loginErrorMessage_when_empty_description_then_falls_back_to_localized_description() {
