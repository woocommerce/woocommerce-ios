...
class StringRandomTests: XCTestCase {
    ...
    func testRandomStringLengthIsAsRequested() {
        XCTAssertEqual(
            String.randomString(usingCharacters: "abc", withLenght: 10).count,
            10
        )
    }
    ...
    func testRandomStringUsesGivenCharactersOnly() {
        ...
        let randomString = String.randomString(usingCharacters: "abc", withLenght: 30)
    ...
    func testRandomStringsAreDifferent() {
        ...
        XCTAssertNotEqual(
            String.randomString(usingCharacters: characters, withLenght: length),
            String.randomString(usingCharacters: characters, withLenght: length)
        )
    }
}
