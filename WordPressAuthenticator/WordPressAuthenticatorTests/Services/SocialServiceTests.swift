...
class SocialServiceTests: XCTestCase {
    ...
    func testSocialServiceUserApple() throws {
        let socialService = SocialUser.apple(user: .init(email: "test@email.com", fullName: "Full Name"))
    ...
    func testSocialServiceUserGoogle() throws {
        let socialService = SocialUser.google(user: .init(email: "email@test.com", fullName: "Name Full"))
