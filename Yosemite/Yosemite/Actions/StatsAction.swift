...
public enum StatsAction: Action {
    ...
    // FIXME: We are returning SiteVisitStats in the completion handler...this needs to eventually return an error/nil much like
    // OrderAction.retrieveOrders. Update this once SiteVisitStats storage is in place.
