...
public struct POSVariation: POSOrderableItem, OrderSyncProductVariationTypeProtocol, Equatable, Hashable, Identifiable {
    // POSOrderableItem
    public let id: UUID
...
extension POSVariation {
    ...
    public func matches(orderItem: OrderItem) -> Bool {
        ...
        return productID == orderItem.productID && productVariationID == orderItem.variationID
    }
}
