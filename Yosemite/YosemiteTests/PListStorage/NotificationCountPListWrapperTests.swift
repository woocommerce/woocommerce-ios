...
final class NotificationCountPListWrapperTests: XCTestCase {
    ...
    func testNotificationCountReturns0WithoutDataForTheSite() {
        let wrapper = NotificationCountPListWrapper(notificationCountBySite: [:])
    ...
    func testNotificationCountReturns0WithoutDataForTheType() {
        let wrapper = NotificationCountPListWrapper(notificationCountBySite: [defaultSiteID: [.comment: 2]])
    ...
    func testNotificationCountForAllTypes() {
        let wrapper = NotificationCountPListWrapper(notificationCountBySite: [defaultSiteID: [.comment: 2, .storeOrder: 6]])
