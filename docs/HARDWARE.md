...
1. [Create a Payment Intent](https://stripe.com/docs/terminal/payments#create-payment). Payment intents are created on device using the connected card reader.
