...
- When setting an attribute of type `Date`/`UUID`/`URI` as non-optional, a default value should be set or the property should be kept optional in Swift. More details [here](https://holko.pl/2017/09/18/surprising-non-optional-nsmanaged/).
