...
* Install WooPayments on a WooCommerce site. Do not run the setup assistant yet.
...
* Run the WooPayments setup assistant. It should indicate that it is running in "TEST DATA" mode. That would allow entering mock data.
