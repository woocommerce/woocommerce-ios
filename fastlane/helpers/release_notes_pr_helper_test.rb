...
class ReleaseNotesPRHelperTest < Minitest::Test # rubocop:disable Metrics/ClassLength
  ...
  REQUIRED_PROMPT_FRAGMENTS = [
    ...
    'Do not infer or specify a device, platform, or hardware',
    'iPhone and iPad',
    'Don\'t turn "your pocket" into "your iPhone"',
    ...
    'say goodbye to',
    'without any hiccups',
    'Describe bug fixes in terms of what now works',
    "When items don't share a theme",
    'separate them with sentence breaks',
    'rollout caveats',
    'attached to the feature they qualify',
